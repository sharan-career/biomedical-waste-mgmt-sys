...
const customerFormSchema = z.object({
  ...
  routeId: z.preprocess((val) => (val === '' ? undefined : val), z.string().uuid().optional()),
  address: z.string().min(2, 'Required'),
  city: z.string().min(2, 'Required'),
  state: z.string().min(2, 'Required'),
  pincode: z.string().min(4, 'Required'),
  gstNumber: z.preprocess((val) => (val === '' ? undefined : val), z.string().optional()),
  panNumber: z.preprocess((val) => (val === '' ? undefined : val), z.string().optional()),
